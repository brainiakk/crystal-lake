...
<hr>
    <div class="milenia-content">
        <header class="milenia-page-header milenia-entity-single milenia-entity--room">
            ...
            <div class="col-lg-9">
                <h1>Diplomatic Room</h1>
            </div>
            <div class="col-lg-3">
                <div class="milenia-entity-meta">
                    <div>from <strong class="milenia-entity-price">N55,000</strong>/night</div>
                </div>
            </div>
            </div>
        </header>
        ...
        <div class="milenia-section milenia-has-sidebar">
            ...
            <main class="col-lg-9 col-md-8 milenia-entity-single milenia-entity--room">
                ...
                <div id="simple-slideshow-1" class="owl-carousel milenia-simple-slideshow"><img src="{{ asset('images/diplomatic-suite_1.png') }}" alt=""><img src="{{ asset('images/diplomatic-suite_2.png') }}" alt=""><img src="{{ asset('images/diplomatic-suite_3.png') }}" alt="">
                </div>
                <div data-sync="#simple-slideshow-1" class="owl-carousel owl-carousel--nav-edges owl-carousel--nav-onhover owl-carousel--nav-small milenia-simple-slideshow-thumbs"><img src="{{ asset('images/diplomatic-suite_1.png') }}" alt=""><img src="{{ asset('images/diplomatic-suite_2.png') }}" alt=""><img src="{{ asset('images/diplomatic-suite_3.png') }}" alt="">
                </div>
                <!--================ Tabs ================-->
                <div class="milenia-tabs milenia-tabs--style-2 milenia-tabs--tour-sections-lg">
                    ...
                    <div id="tab-description" tabindex="0" role="tabpanel" aria-labelledby="tab-description-link" class="milenia-tab">
                        <p>Our Diplomatic Suites are carefully furnished and designed with colors that create a comforting ambiance and homely feel for guests.</p><a href="#" data-fancybox-album-src="[{&quot;src&quot;: &quot;images/floor-plan.png&quot;, &quot;opts&quot;: {&quot;caption&quot;: &quot;The floor plan&quot;}}]" class="milenia-btn milenia-btn--link milenia-btn--scheme-primary"></a>
                    </div>
                    <!--================ End of Tab ================-->
                    <!--================ Tab ================-->
